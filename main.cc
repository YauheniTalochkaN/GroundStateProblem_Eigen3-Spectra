...
void build_sparse_hamiltonian(int N, int dim,   
                              ...
                              Eigen::SparseMatrix<complexType>& H1z,
                              Eigen::SparseMatrix<complexType>& H) 
{       
...
int main(int argc, char* argv[]) 
{
    ...
    Eigen::SparseMatrix<complexType> H1z(DIM, DIM);
    Eigen::SparseMatrix<complexType> H(DIM, DIM);
    ...
    for(size_t iter = 0; iter < num_iters; ++iter)
    {
        ...
        Spectra::SparseHermMatProd<complexType> opH(H);

        Spectra::HermEigsSolver<Spectra::SparseHermMatProd<complexType>> eigsH(opH, 1, 10);
